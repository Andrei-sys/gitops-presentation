...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
 pr-2629c623-2763-4255-9770-74fb0643af4f
 ...
 main
	    ...
	    <tr>
	      <td><a href='' title='A Helm chart for Kubernetes'> <img src='https://raw.githubusercontent.com/cdfoundation/artwork/master/jenkinsx/icon/color/jenkinsx-icon-color.png' width='24px' height='24px'> http-python-jx </a></td>
	      <td>0.0.1</td>
	      <td></td>
	      <td></td>
	    </tr>
